...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ibmpairs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8350&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ibmpairs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ibmpairs` can be installed with:

```
conda install ibmpairs
```

It is possible to list all of the versions of `ibmpairs` available on your platform with:
